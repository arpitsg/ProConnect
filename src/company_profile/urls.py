...
from .views import my_profile_company_view , single_job_view, job_list,saved_job_list,edit_job_view,view_applications,applied_job_list,other_company
...
path('other_company/<int:id>/',other_company,name='other_company'),
