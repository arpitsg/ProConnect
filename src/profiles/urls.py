...
from .views import my_profile_view,edit_skills,map,other_user,add_education,add_experience,add_skill,add_language,add_project,edit_language,edit_skill,edit_education,edit_project,edit_experience,delete_language,delete_skill,delete_education,delete_experience,delete_project
app_name = 'profiles'
